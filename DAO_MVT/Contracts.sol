...
// Copyright The Movement DAO 2021
// MIT License
...
// This means that cyclic creation dependencies are impossible." Ethereum, Solidity Documentation (March 20, 2021).
...
constructor(bytes32 _name) {
    ...
    // but the latter provides an external view to the function. 
    // Especially in the constructor, you should not access functions externally,
...
function changeName(bytes32 newName) public { 
    ...
    // We compare the contract based on its address,
    // which can be retrieved by explicit conversion to address.
    ...
    function transfer(address newOwner) public {
        ...
        // `TokenCreator` contract defined below. 
...
contract TokenCreator {
        ...
        returns (OwnedToken tokenAddress) 
    {
        ...
        // From the JavaScript side, the return type of this function is `address`, 
